...
# Parâmetros    
url_dados = "database/penguins_size.csv"
colunas = ['species', 'island', 'culmen_length_mm', 'culmen_depth_mm', 'flipper_length_mm', 'body_mass_g', 'sex',]
...
def test_modelo_lr():  
    ...
    lr_path = 'ml_model/classificador.pkl'
